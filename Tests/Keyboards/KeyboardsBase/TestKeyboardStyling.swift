...
extension KeyboardStylingTest {
    func testStyleDeleteButton() {
        ...
        let pressedButtonImage = UIImage(
            systemName: pressedIconName, withConfiguration: pressedButtonIconConfig
        )
        let unpressedButtonImage = UIImage(
            systemName: unpressedIconName, withConfiguration: unpressedButtonIconConfig
        )
...
extension KeyboardStylingTest {
    func testAddPadding() throws {
        ...
        let padding = try XCTUnwrap(stackView.subviews.first as? UIButton)
