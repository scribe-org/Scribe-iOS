...
struct NBKeyboardProvider: KeyboardProviderProtocol {
    ...
    static func genPadExpandedLetterKeys() -> [[String]] {
        return KeyboardBuilder()
            ...
            .addRow([
                SpecialKeys.capsLock, "a", "s", "d", "f", "g", "h", "j", "k", "l", "ø", "æ", "'",
                "return"
            ])
            .addRow(["shift", "*", "z", "x", "c", "v", "b", "n", "m", ",", ".", "-", "shift"])
            .addRow(["selectKeyboard", ".?123", "space", ".?123", "hideKeyboard"])
...
func setNBKeyboardLayout() {
    ...
    invalidCommandTextWikidata1 =
        "Wikidata er en samarbeidsredigert kunnskapsgraf som vedlikeholdes av Wikimedia Foundation. Den fungerer som en kilde til åpne data for prosjekter som Wikipedia og utallige andre."
    invalidCommandTextWikidata2 =
        "Scribe bruker Wikidatas språkdata for mange av kjernefunksjonene. Vi får informasjon som substantivkjønn, verbkonjugasjoner og mye mer!"
    invalidCommandTextWikidata3 =
        "Du kan opprette en konto på wikidata.org for å bli med i fellesskapet som støtter Scribe og mange andre prosjekter. Hjelp oss å bringe gratis informasjon til verden!"

    invalidCommandMsgWiktionary = "Ikke i Wiktionary"
    invalidCommandTextWiktionary1 =
        "Wiktionary er en samarbeidsredigert ordbok som vedlikeholdes av Wikimedia Foundation. Den fungerer som en kilde til gratis språkdata for prosjekter som Wikipedia og utallige andre."
    invalidCommandTextWiktionary2 =
        "Scribe bruker Wiktionarys data for å tilby oversettelser for sin Oversett-kommando. Dataene våre er hentet fra de mange språkparene som Wiktionarys fellesskap har laget!"
    invalidCommandTextWiktionary3 =
        "Du kan opprette en konto på wiktionary.org for å bli med i fellesskapet som støtter Scribe og mange andre prosjekter. Hjelp oss å bringe gratis informasjon til verden!"
