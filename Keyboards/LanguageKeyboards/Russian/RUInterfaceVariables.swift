...
struct RUKeyboardProvider: KeyboardProviderProtocol {
    ...
    static func genPadExpandedLetterKeys() -> [[String]] {
        return KeyboardBuilder()
            ...
            .addRow([
                SpecialKeys.capsLock, "ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "ё",
                "return"
            ])
            .addRow(["shift", "'", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "/", "shift"])
            .addRow(["selectKeyboard", ".?123", "space", ".?123", "hideKeyboard"])
...
func setRUKeyboardLayout() {
    ...
    invalidCommandTextWikidata1 =
        "Wikidata — это совместно редактируемый граф знаний, поддерживаемый Фондом Викимедиа. Он служит источником открытых данных для таких проектов, как Википедия и бесчисленное множество других."
    invalidCommandTextWikidata2 =
        "Scribe использует языковые данные Wikidata для многих своих основных функций. Мы получаем информацию о родах существительных, спряжениях глаголов и многом другом!"
    ...
    invalidCommandTextWiktionary1 =
        "Wiktionary — это совместно редактируемый словарь, поддерживаемый Фондом Викимедиа. Он служит источником бесплатных лингвистических данных для таких проектов, как Википедия и бесчисленное множество других."
    invalidCommandTextWiktionary2 =
        "Scribe использует данные Wiktionary для предоставления переводов для своей команды «Перевести». Наши данные получены из множества языковых пар, созданных сообществом Wiktionary!"
