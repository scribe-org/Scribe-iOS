...
extension UIColor {
  ...
  static let previewBlueDarkTheme = UIColor(red: 50.0/255.0, green: 75.0/255.0, blue: 204.0/255.0, alpha: 1.0)
  static let previewGreenDarkTheme = UIColor(red: 75.0/255.0, green: 204.0/255.0, blue: 75.0/255.0, alpha: 1.0)
