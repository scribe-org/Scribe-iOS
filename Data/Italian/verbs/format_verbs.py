...
if "Italian/verbs/" not in file_path:
    with open(
        "../../../Keyboards/LanguageKeyboards/Italian/Data/verbs.json",
        "w",
        encoding="utf-8",
    ) as f:
    ...
    with open(
        "../Keyboards/LanguageKeyboards/Italian/Data/verbs.json", "w", encoding="utf-8",
    ) as f:
        json.dump(verbs_formatted, f, ensure_ascii=False, indent=2)
