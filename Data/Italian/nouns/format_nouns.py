...
if "Italian/nouns/" not in file_path:
    with open(
        "../../../Keyboards/LanguageKeyboards/Italian/Data/nouns.json",
        "w",
        encoding="utf-8",
    ) as f:
    ...
    with open(
        "../Keyboards/LanguageKeyboards/Italian/Data/nouns.json", "w", encoding="utf-8",
    ) as f:
        json.dump(nouns_formatted, f, ensure_ascii=False, indent=2)
