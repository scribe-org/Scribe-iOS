...
class InformationScreenVC: UIViewController {
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        if traitCollection.hasDifferentColorAppearance(comparedTo: previousTraitCollection) {
            if section == .wikimedia {
                textView.attributedText = switchAttachmentOnThemeChange(
    ...
    func setupInformationPageUI() {
        ...
        applyCornerRadius(
            elem: contentContainerView, radius: contentContainerView.frame.width * 0.05
        )
    ...
    func setupPrivacyPolicyPage() {
        ...
        textView.attributedText = setPrivacyPolicy(
            fontSize: fontSize,
    ...
    func setupWikimediaAndScribePage() {
        ...
        textView.attributedText = setWikimediaAndScribe(
            text: wikimediaAndScribeText, fontSize: fontSize,
            imageWidth: contentContainerView.frame.width * 0.6
        )
        textView.textColor = keyCharColor
    }
}
