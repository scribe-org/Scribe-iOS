...
let wikimediaAndScribeTitle = NSLocalizedString("app.about.wikimedia", value: "Wikimedia and Scribe", comment: "")
let wikimediaAndScribeCaption = NSLocalizedString("app.about.wikimedia.caption", value: "How we work together", comment: "")
