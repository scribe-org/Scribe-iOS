...
let wikimediaAndScribeTitle = NSLocalizedString(
    "i18n.app.about.community.wikimedia", value: "Wikimedia and Scribe", comment: ""
)
let wikimediaAndScribeCaption = NSLocalizedString(
    "i18n.app.about.community.wikimedia.caption", value: "How we work together", comment: ""
)
...
let wikimediaAndScribeText = [
    wikimediaAndScribeText1, wikimediaAndScribeText2, wikimediaAndScribeText3
]
