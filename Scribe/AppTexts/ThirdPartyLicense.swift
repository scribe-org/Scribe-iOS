...
let thirdPartyLicensesTitle = NSLocalizedString(
    "i18n.app.about.legal.third_party",
    value: "Third-party licenses",
    comment: ""
)
let thirdPartyLicensesCaption = NSLocalizedString(
    "i18n.app.about.legal.third_party.caption",
    value: "Whose code we used",
    comment: ""
)

let thirdPartyLicensesText =
    NSLocalizedString(
