...
enum SettingsTableData {
    static let settingsTableData: [ParentTableCellModel] = [
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.menu.title", value: "App settings", comment: ""
            ),
            section: [
                Section(
                    sectionTitle: NSLocalizedString(
                        "i18n.app.settings.menu.app_language", value: "App language", comment: ""
                    ),
                    hasToggle: false,
                    sectionState: .appLang,
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.translation.select_source",
                        value: "Select language for app texts.", comment: ""
                    )
                ),
                Section(
                    sectionTitle: NSLocalizedString(
        ...
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.keyboard.title", value: "Select installed keyboard", comment: ""
            ),
            section: [],
    ...
    static let languageSettingsData: [ParentTableCellModel] = [
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.translation", value: "Translation", comment: ""
            ),
            section: [
                Section(
                    sectionTitle: NSLocalizedString(
                        "i18n.app.settings.keyboard.translation.title",
                        value: "Translation source language",
                        comment: ""
                    ),
                    sectionState: .translateLang,
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.translation.select_source_description",
                        value: "Change the language to translate from.", comment: ""
                    )
                )
            ],
            hasDynamicData: nil
        ...
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.keyboard.layout.title", value: "Layout", comment: ""
            ),
            section: [
                Section(
                    sectionTitle: NSLocalizedString(
                        "i18n.app.settings.keyboard.layout.period_and_comma",
                    ...
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.layout.period_and_comma_description",
                        value:
                        "Include comma and period keys on the main keyboard for convenient typing.",
                        comment: ""
                    )
                ),
                Section(
                    ...
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.layout.disable_accent_characters_description",
        ...
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.keyboard.functionality.title", value: "Functionality",
                comment: ""
            ),
            section: [
                Section(
                    sectionTitle: NSLocalizedString(
                        "i18n.app.settings.keyboard.functionality.double_space_period",
                        value: "Double space periods", comment: ""
                    ),
                    hasToggle: true,
                    sectionState: .none(.doubleSpacePeriods),
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.functionality.double_space_period_description",
                ...
                Section(
                    sectionTitle: NSLocalizedString(
                        "i18n.app.settings.keyboard.functionality.auto_suggest_emoji",
                        value: "Autosuggest emojis", comment: ""
                    ),
                    hasToggle: true,
                    sectionState: .none(.autosuggestEmojis),
                    shortDescription: NSLocalizedString(
                        "i18n.app.settings.keyboard.functionality.auto_suggest_emoji_description",
                        value:
                        "Turn on emoji suggestions and completions for more expressive typing.",
                        comment: ""
                    )
                ),
                Section(
                    sectionTitle: NSLocalizedString(
                        ...
                        value: "Word for word deletion on long press", comment: ""
                    ),
                    hasToggle: true,
    ...
    static let translateLangSettingsData: [ParentTableCellModel] = [
        ParentTableCellModel(
            headingTitle: NSLocalizedString(
                "i18n.app.settings.keyboard.translation.select_source.caption",
                value: "What the source language is", comment: ""
            ),
    ...
    static func getInstalledKeyboardsSections() -> [Section] {
        ...
        guard
            let keyboards = UserDefaults.standard.dictionaryRepresentation()["AppleKeyboards"]
            as? [String]
        else { return [] }
